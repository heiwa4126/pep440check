...
def main() -> None:
    ...
    parser.add_argument("path", nargs="?", default="pyproject.toml", help="pyproject.tomlのパス")
    ...
    if not is_valid:
        print(f"エラー: バージョン '{version_str}' はPEP 440準拠ではありません", file=sys.stderr)
        sys.exit(1)
